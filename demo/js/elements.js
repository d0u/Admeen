...
$(document).ready(function() { 	
	...
	$( "#slider-range" ).slider({
		...
		values: [ 75, 300 ],
		slide: function( event, ui ) {
			$( "#amount1" ).val( "价格范围: ￥" + ui.values[ 0 ] + " - ￥" + ui.values[ 1 ] );
		}
	});
	$( "#amount1" ).val( "价格范围: ￥" + $( "#slider-range" ).slider( "values", 0 ) +
	...
	$( "#slider-range-min" ).slider({
		...
		max: 700,
		slide: function( event, ui ) {
			$( "#amount2" ).val( "最大价格: ￥" + ui.value );
		}
	});
	$( "#amount2" ).val( "最大价格: ￥" + $( "#slider-range-min" ).slider( "value" ) );
	//with maximum
	$( "#slider-range-max" ).slider({
		...
		value: 2,
		slide: function( event, ui ) {
			$( "#amount3" ).val("最小值:" + ui.value );
		}
	});
	$( "#amount3" ).val( "最小值:" + $( "#slider-range-max" ).slider( "value" ) );
