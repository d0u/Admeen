	...
	function supportPage(){
		...
		function msgReply(chatText) {
			...
			if (chatText.length) {
				...
				cont.find('li:last-child').append('<a href="#" class="avatar"><img src="images/avatar3.jpeg" alt=""></a><div class="message"><div class="head clearfix"><span class="name"><strong>你</strong> 说:</span><span class="time">刚刚</span></div><p></p></div>');
