...
$(document).ready(function() { 	
	...
	$(function () {
		var data = [
		    { label: "北京",  data: 38, color: "#88bbc8"},
		    { label: "广东",  data: 23, color: "#ed7a53"},
		    { label: "上海",  data: 15, color: "#9FC569"},
		    { label: "湖南",  data: 9, color: "#bbdce3"},
		    { label: "福建",  data: 7, color: "#9a3b1b"},
		    { label: "山东",  data: 5, color: "#5a8022"},
		    { label: "河南",  data: 3, color: "#2c7282"}
		];
