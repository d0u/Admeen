...
$(document).ready(function() { 	
	...
	//------------- Masked input fields -------------//
	$("#mask-phone").mask("(999) 9999-9999", {completed:function(){alert("完成后会致电给您");}});
	$("#mask-phoneExt").mask("(999) 999-9999 转 99999");
	$("#mask-phoneInt").mask("+86 (999) 9999-9999");
	$("#mask-date").mask("9999年99月99日");
	$("#mask-ssn").mask("9999 9999 9999 9999");
